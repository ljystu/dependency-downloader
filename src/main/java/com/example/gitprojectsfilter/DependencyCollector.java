...
import com.example.gitprojectsfilter.validation.ClassLoaderExample;
import com.example.gitprojectsfilter.validation.DynamicProxyExample;
import com.example.gitprojectsfilter.validation.ReflectionExample;
...
//        ReflectionExample.main(new String[]{});
//        DynamicProxyExample.main(new String[]{});
        ClassLoaderExample.main(new String[]{});
...
//        String path = "/Users/ljystu/Desktop/projects/" + project.getName();
        try {
            ...
            boolean b = cloneProcess.waitFor(20, TimeUnit.MINUTES);
...
//        }
        try {
            ...
            boolean b = process.waitFor(15, TimeUnit.MINUTES);
...
//                DownloadHelper.deleteFile(new File(dir));
            ...
            while ((line = bufferedReader.readLine()) != null) {
                if (line.contains("fatal") || line.contains("error")) break;
